...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'add_question.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/add_question.html'`` the file from the app1 package is loaded,
    by loading ``'app2/add_question.html'`` the file from the second.
    """
